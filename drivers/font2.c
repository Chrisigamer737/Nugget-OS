...
extern char _binary_font3_psf_start;
extern char _binary_font3_psf_start;
extern char _binary_font3_psf_end;
...
void psf_init()
{
    ...
    PSF_font *font = (PSF_font*)&_binary_font3_psf_start;
    ...
    char *s = (char *)(
    (unsigned char*)&_binary_font3_psf_start +
      font->headersize +
      font->numglyph * font->bytesperglyph
    );
    /* allocate memory for translation table */
    unicode = calloc(USHRT_MAX, 2);
    while(s>_binary_font3_psf_end) {
