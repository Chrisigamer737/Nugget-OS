...
extern char _binary_drivers_font3_psf_start;
extern char _binary_drivers_font3_psf_size;
extern char _binary_drivers_font3_psf_end;
...
void psf_init()
{
    ...
    PSF_font *font = (PSF_font*)&_binary_drivers_font3_psf_start;
    ...
    char *s = (char *)(
    (unsigned char*)&_binary_drivers_font3_psf_start +
      font->headersize +
	...
	//for (int i;i <= 255; i++){
		unicode = mem_alloc(2);
	//}
    while(s>_binary_drivers_font3_psf_end) {
